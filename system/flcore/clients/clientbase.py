...
from fairlearn.metrics import MetricFrame, selection_rate, false_positive_rate, false_negative_rate, count, equalized_odds_difference, demographic_parity_difference
...
class Client(object):
    ...
    def __init__(self, args, id, train_samples, test_samples, **kwargs):
        ...
        # ! attack model
        # self.adv_client_num = args.adversaries_num
